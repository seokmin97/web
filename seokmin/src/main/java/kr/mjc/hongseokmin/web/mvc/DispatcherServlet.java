...
public class DispatcherServlet extends HttpServlet {
  ...
  protected void service(HttpServletRequest request,
    ...
    switch (uri) {
      ...
      case "/mvc/article/articleList" -> ArticleController.articleList(request, response); //게시글목록
      case "/mvc/article/articleDetail" -> ArticleController.articleDetail(request, response);
      case "/mvc/article/articleAdd" ->ArticleController.articleAdd(request, response);
